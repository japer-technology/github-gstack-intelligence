...
> Source: `garrytan/gstack` @ ref `main` from `browse/SKILL.md.tmpl`.
...
- This is the extracted `/browse` skill prompt committed into the repository at refresh time.
...
# 2. Tell the user what happened (via GitHub follow-up comment)

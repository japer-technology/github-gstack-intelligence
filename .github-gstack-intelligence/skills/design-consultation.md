...
> Source: `garrytan/gstack` @ `7ea6ead9fa88` from `design-consultation/SKILL.md.tmpl`.
...
_DESIGN_DIR=.github-gstack-intelligence/state/results/$SLUG/designs/design-system-$(date +%Y%m%d)
mkdir -p "$_DESIGN_DIR"

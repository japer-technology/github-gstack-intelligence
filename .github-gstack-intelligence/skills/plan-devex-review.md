...
> Source: `garrytan/gstack` @ ref `main` from `plan-devex-review/SKILL.md.tmpl`.
...
- This is the extracted `/plan-devex-review` skill prompt committed into the repository at refresh time.
...
Then SHOW it to the user via GitHub follow-up comment:
...
Load the "## Pass 1" section from `.github-gstack-intelligence/skills/plan-devex-review/dx-hall-of-fame.md`
...
3. **GitHub follow-up comment per friction point.** One question per friction point found.
...
7. GitHub follow-up comment if there's a genuine DX choice to resolve
...
- **DX EXPANSION:** After fixing to 10, also ask "What would make this dimension
  ...
  individual opt-in GitHub follow-up comments.
...
.github-gstack-intelligence/skills/bin/gstack-review-read 2>/dev/null | grep plan-devex-review || echo "NO_PRIOR_DX_REVIEWS"
```
...
Load reference: Read the "## Pass 1" section from `.github-gstack-intelligence/skills/plan-devex-review/dx-hall-of-fame.md`.
...
**STOP.** GitHub follow-up comment once per issue. Recommend + WHY. Reference the persona.
...
Load reference: Read the "## Pass 2" section from `.github-gstack-intelligence/skills/plan-devex-review/dx-hall-of-fame.md`.
...
**STOP.** GitHub follow-up comment once per issue. Recommend + WHY.
...
Load reference: Read the "## Pass 3" section from `.github-gstack-intelligence/skills/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 4" section from `.github-gstack-intelligence/skills/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 5" section from `.github-gstack-intelligence/skills/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 6" section from `.github-gstack-intelligence/skills/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 7" section from `.github-gstack-intelligence/skills/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 8" section from `.github-gstack-intelligence/skills/plan-devex-review/dx-hall-of-fame.md`.
...
`.github-gstack-intelligence/skills/plan-devex-review/dx-hall-of-fame.md`.

Check each item. For any unchecked item, explain what's missing and suggest the fix.

**STOP.** GitHub follow-up comment for any item that requires a design decision.
...
Follow the GitHub follow-up comment format from the Preamble above. Additional rules for
DX reviews:

* **One issue = one GitHub follow-up comment call.** Never combine multiple issues.
...
GitHub follow-up comment. Never batch. For DX debt: missing error messages, unspecified upgrade
...
Use GitHub follow-up comment with applicable options:

...
> Source: `garrytan/gstack` @ `7ea6ead9fa88` from `benchmark/SKILL.md.tmpl`.
...
- This is the extracted `/benchmark` skill prompt committed into the repository at refresh time.
...
mkdir -p .github-gstack-intelligence/state/local/benchmark-reports
mkdir -p .github-gstack-intelligence/state/local/benchmark-reports/baselines
```
...
Write to `.github-gstack-intelligence/state/local/benchmark-reports/baselines/baseline.json`.
...
Write to `.github-gstack-intelligence/state/local/benchmark-reports/{date}-benchmark.md` and `.github-gstack-intelligence/state/local/benchmark-reports/{date}-benchmark.json`.

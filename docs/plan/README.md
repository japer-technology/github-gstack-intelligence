# Plan: Githubification of gstack via Pi-Mono
...
**Transformation + Native Hybrid.** gstack's interaction model must change from interactive/local to event-driven/remote (Transformation), while the GitHub Actions orchestration layer is built from scratch using the GMI lifecycle pattern (Native).
...
|---|----------|----------------|
| 01 | [Resource Extraction](01-resource-extraction.md) | What to extract from gstack, what to leave behind, and why |
...
| 04 | [Architecture](04-architecture.md) | Folder structure, lifecycle scripts, skill router, and configuration |
| 05 | [Workflows](05-workflows.md) | GitHub Actions workflow definitions for each skill tier |
| 06 | [State Management](06-state-management.md) | Git-as-memory patterns for sessions, benchmarks, retros, and QA reports |
| 07 | [Cost and Controls](07-cost-and-controls.md) | Cadence reduction, access control, model tiering, and cost management |
| 08 | [Implementation Phases](08-implementation-phases.md) | Five-phase rollout from proof-of-concept to marketplace distribution |
...
| GMI reference implementation | `.github-minimum-intelligence/` | Proven lifecycle pattern (indicator.ts, agent.ts, state/) |
